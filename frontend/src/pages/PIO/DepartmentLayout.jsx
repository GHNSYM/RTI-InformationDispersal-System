  ...
  const navigation = [
    {
      ...
      href: "/department",
      icon: HomeIcon,
      current: location.pathname === "/department",
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="fixed inset-0 flex">
            ...
            >
              <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
                <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-gradient-to-b from-blue-600 to-blue-400 px-6 pb-4 backdrop-blur-sm">
      ...
      <div className="lg:pl-56">
        <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-blue-600 px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
          <button
            type="button"
